...
# Defining a new class called "NubbinBattery" that inherits from the "Battery" class.
class NubbinBattery(Battery):
    ...
    # If the battery was last serviced more than 4 years ago, it needs to be serviced.
